        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden aspect-square lg:aspect-[4/3]">
              ...
              {/* Floating Stats Card */}
              <motion.div
                className="absolute bottom-6 left-6 right-6 lg:right-auto lg:w-72 glass-card rounded-xl p-4 bg-white/90 backdrop-blur-md shadow-lg"
              ...
              >
                <div className="flex items-center gap-4">
                  {stats.map((stat, index) => (
                    <div key={stat.label} className={`flex-1 ${index !== 0 ? "border-l border-border pl-4" : ""}`}>
